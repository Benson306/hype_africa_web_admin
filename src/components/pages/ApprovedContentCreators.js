...
function ApprovedContentCreators() {
  ...
  return (
    <div className="w-full min-h-screen bg-neutral-300">
        <div className='p-4 ml-16 text-gray-900 font-mono'>Approved Creators Applications</div>
        ...
        { data.length < 1 && <div className='text-center bg-neutral-900 text-white p-4 rounded-lg'>
            You have not approved any application
            </div>}
...
export default ApprovedContentCreators
